...
SECRET_KEY = 'django-insecure-r6t+h5-jfd-vm05&w=lupp*u!70@n%1y)&+jt=644z8=h$ja_q'
...
MEDIA_URL = '/media/' # url onde vai ser salvo
MEDIA_ROOT = os.path.join(BASE_DIR,'media')# onde vaiser salvo
